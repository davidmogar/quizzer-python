...
[![Build Status](https://travis-ci.org/davidmogar/quizzer-python.svg?branch=master)](https://travis-ci.org/davidmogar/quizzer-python)

This is the Python version of Quizzer, a simple application to parse JSON files with questons and answers of students to these questions to generate and/or validate grades for all the students.
...
Quizzer require Flask 0.10.1 to be able to start the web service.
